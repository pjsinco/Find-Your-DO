...
var PhysicianListItemView = Backbone.View.extend({
    ...
    template: _.template(
            ...
            '<h3 class="fyd-results__name">' +
                ...
                '<% if (aoa_cert) { %><span class="fyd-results__imagecontainer"><img src="' + 
                    fydSettings.imagePath + '/logo-aoa-board-certified-28.png" /></span><% } %>' +
            '</h3>' +
...
},{"backbone":24,"jquery":25,"underscore":26,"views/location-form":16,"views/specialty-form":22}],22:[function(require,module,exports){
var Backbone = require('backbone'),
    $ = require('jquery'),
    _ = require('underscore'),
    typeahead = require('typeahead.0.10.5');
...
var SpecialtyView = Backbone.View.extend({
    ...
    physicianSuggestionTemplate: _.template(
        '<div>' +
            '<a id="physicianLink" href="find-your-do-results#physicians/<%= id %>"><%= full_name %><br />' +
